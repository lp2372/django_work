...
sys.path.insert(0,os.path.join(BASE_DIR,'artBD/apps'))
...
ROOT_URLCONF = 'artBD.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'artBD/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'artBD.wsgi.application'
