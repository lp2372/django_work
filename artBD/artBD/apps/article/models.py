...
class ArtBD_article(models.Model):
    ...
    addtime = models.CharField(max_length=50,null=True,verbose_name='发布时间')
...
class ArtBD_Article_Keyword(models.Model):
    ...
    weight = models.SmallIntegerField(null=False,default='0')
    article = models.ForeignKey('ArtBD_article',on_delete=models.CASCADE)

    class Meta:
        db_table = 'artBD_article_keyword'

#  CREATE TABLE `artBD_article_result_keyword` (
#   `id` bigint(20) NOT NULL AUTO_INCREMENT,
#   `auction_result_id` bigint(20) NOT NULL,
#   `name` varchar(32) NOT NULL,
#   `times` smallint(6) NOT NULL DEFAULT '1',
#   PRIMARY KEY (`id`),
#   KEY `auction_result_id` (`auction_result_id`)
# ) ENGINE=MyISAM DEFAULT CHARSET=utf8

class ArtBD_Auction_Result_Keyword(models.Model):

    name = models.CharField(max_length=32)
    times = models.SmallIntegerField(null=False,default='1')
    weight = models.SmallIntegerField(null=False,default='0')
    auction_result = models.ForeignKey('ArtBD_auction_result',on_delete=models.CASCADE)

    class Meta:
        db_table = 'artBD_auction_result_keyword'
